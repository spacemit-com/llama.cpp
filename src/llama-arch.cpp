...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_Q3TTS_CODEC_EMBD,                       "q3tts.codec_embedding" },
    { LLM_TENSOR_Q3TTS_TALKER_HEAD,                      "q3tts.talker_head_f16" },
    { LLM_TENSOR_Q3TTS_CP_EMBD,                          "q3tts.cp_embedding.%d" },
    { LLM_TENSOR_Q3TTS_CP_HEAD_F16,                      "q3tts.cp_head_f16.%d" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_Q3TTS_CODEC_EMBD,           {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_Q3TTS_TALKER_HEAD,          {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_NONE}},
    {LLM_TENSOR_Q3TTS_CP_EMBD,              {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_Q3TTS_CP_HEAD_F16,          {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_NONE}},
